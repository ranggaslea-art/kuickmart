...
export const INITIAL_BRAND_CONFIG: BrandHeaderFooterConfig = {
  ...
  brandNamePart1: 'TOKO',
  brandNamePart2: 'ONLINE',
  brandBadgeText: '.ONLINE',
  brandBadgeColor: 'bg-red-600',
  showBrandBadge: true,
  tagline: 'Pusat Belanja Online Hemat & Cepat',
  showTagline: true,
  operatingHoursBadgeText: '24 Jam Nonstop',
  showOperatingHoursBadge: true,

  // 2. Footer Brand & Overview
  footerBrandName: 'TOKO-ONLINE.ONLINE',
  footerDescription: 'Platform belanja & minimarket online terpercaya dengan sistem multi-tenant terisolasi, integrasi cloud database, dan pengiriman kilat.',
  ...
  copyrightText: '© 2026 toko-online.online. All rights reserved.',
  bottomLinks: [
...
export const INITIAL_COURIERS: CourierInfo[] = [
  ...
  },
  {
    ...
    totalDeliveries: 412,
    storeId: 'str_01',
    notes: 'Standby di toko-online.online Sudirman Thamrin, pengiriman cepat maks 15 menit.',
...
export const INITIAL_STORE_PROMOS: StorePromoInfo[] = [
  ...
  },
  {
    ...
    subtitle: 'Berlaku di seluruh cabang toko-online.online',
...
export const INITIAL_RECEIPT_CONFIGS: ReceiptInfo[] = [
  {
    ...
    headerBrand: 'TOKO-ONLINE.ONLINE',
    ...
    websiteOrSocial: 'www.toko-online.online • WA: 0812-3456-7890',
  ...
  },
  {
    id: 'rcp_01',
    storeId: 'str_01',
    profileName: 'Struk Standar Toko-Online Thermal (58mm)',
    headerBrand: 'TOKO-ONLINE.ONLINE',
    subHeader: 'Minimarket & Grosir Kebutuhan Sehari-Hari',
    storeName: 'toko-online.online - Sudirman Thamrin',
    address: 'Jl. Jendral Sudirman No. 18, Menteng',
    city: '',
    phone: '021-5551234',
    taxIdOrNpwp: 'NPWP: 01.345.678.9-012.000',
    websiteOrSocial: 'www.toko-online.online • IG: @tokoonline',
    cashierName: 'Kasir 01',
    footerMessage1: 'Struk ini adalah bukti pembayaran sah dari toko-online.online.',
  ...
  },
  {
    id: 'rcp_02',
    storeId: 'str_02',
    profileName: 'Struk Cabang Kuningan Mega (80mm)',
    headerBrand: 'TOKO-ONLINE.ONLINE',
    subHeader: 'Fresh, Hemat & Lengkap Setiap Hari',
    storeName: 'toko-online.online - Kuningan Mega',
...
export const INITIAL_STAFF_USERS: StaffUser[] = [
  {
    ...
    email: 'admin@toko-online.online',
    storeId: 'all',
  ...
  },
  {
    ...
    email: 'kasir1@toko-online.online',
    storeId: 'str_01',
    storeName: 'toko-online.online - Sudirman Thamrin',
    isActive: true,
  ...
  },
  {
    ...
    email: 'gudang@toko-online.online',
    storeId: 'all',
    storeName: 'Semua Cabang',
    isActive: true,
...
export const INITIAL_STORES: Store[] = [
  {
    id: 'str_01',
    name: 'toko-online.online - Sudirman Thamrin',
    code: 'TO-SDM01',
    address: 'Jl. Jendral Sudirman No. 18, Menteng',
    city: '',
    distanceKm: 0.7,
  ...
  {
    id: 'str_02',
    name: 'toko-online.online - Senopati Raya',
    code: 'TO-SNP02',
  ...
  {
    id: 'str_03',
    name: 'toko-online.online - Tebet Eco Park',
    code: 'TO-TBT03',
