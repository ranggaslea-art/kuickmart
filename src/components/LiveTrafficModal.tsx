      ...
      <div className="bg-white rounded-3xl max-w-4xl w-full overflow-hidden shadow-2xl border border-stone-200 animate-in fade-in zoom-in-95 duration-200 my-auto flex flex-col max-h-[92vh]">
        ...
        {!currentUser ? (
              ...
              <div className="pt-4 border-t border-stone-200">
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    ...
                    className="px-2.5 py-1.5 rounded-lg bg-stone-100 hover:bg-amber-100 border border-stone-200 hover:border-amber-300 text-stone-800 text-[11px] font-bold transition-all"
                  >
                    👑 Admin (admin)
                  </button>
                  <button
                    ...
                    className="px-2.5 py-1.5 rounded-lg bg-stone-100 hover:bg-blue-100 border border-stone-200 hover:border-blue-300 text-stone-800 text-[11px] font-bold transition-all"
                  >
                    🛒 Kasir (kasir)
                  </button>
                  <button
                    ...
                    className="px-2.5 py-1.5 rounded-lg bg-stone-100 hover:bg-purple-100 border border-stone-200 hover:border-purple-300 text-stone-800 text-[11px] font-bold transition-all"
                  >
                    👔 SPV (spv)
                  </button>
                </div>
          ...
          <div className="p-5 sm:p-6 overflow-y-auto space-y-6">
            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-3 sm:p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-bold text-emerald-950">
                      Sesi Terverifikasi: <strong>{currentUser.name}</strong>
                    </span>
                  ...
                  <p className="text-[11px] text-emerald-700">
                    Akses penuh ke data live pengunjung, asal kota/wilayah, dan log trafik real-time KuickMart Express.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 self-start sm:self-center">
                <button
                  ...
                  className="px-3 py-1.5 rounded-xl bg-white hover:bg-stone-50 border border-stone-300 text-xs font-bold text-stone-700 flex items-center gap-1.5 shadow-2xs transition-all cursor-pointer disabled:opacity-50"
                >
              ...
              <div className="bg-stone-50 border border-stone-200 rounded-2xl p-4 flex flex-col justify-between">
                ...
                <div className="mt-2">
                  <div className="text-base sm:text-lg font-black text-stone-900 truncate">
                    📍 {stats.detectedLocation.city}
                  </div>
                  <span className="text-[11px] text-stone-500 truncate block">
                    {stats.detectedLocation.region} • Indonesia
                  </span>
                </div>
              </div>
            </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="w-full h-2 bg-stone-200 rounded-full overflow-hidden">
                        <div
                          className={`h-full rounded-full ${isCurrentCity ? 'bg-blue-600' : 'bg-stone-600'}`}
            ...
            <div className="bg-white border border-stone-200 rounded-2xl p-4 sm:p-5 shadow-xs space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-extrabold text-sm sm:text-base text-stone-900">
                    Aktivitas Kunjungan Terkini (Live Feed)
                  </h4>
                </div>
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        {v.isCurrent && (
                          <span className="ml-2 text-[9px] font-black bg-amber-100 text-amber-900 px-1.5 py-0.5 rounded">
                            Sesi Anda
                          </span>
                        )}
                      </div>
                    ...
                    <div className="flex items-center gap-3 text-stone-500 text-[11px]">
                      <span>{v.device}</span>
                      <span>•</span>
                      <span className="font-medium text-stone-700">{v.timeAgo}</span>
                    </div>
                  </div>
                ))}
              </div>
